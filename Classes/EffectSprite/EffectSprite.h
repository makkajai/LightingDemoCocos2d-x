...
namespace effect {
    ...
    public:
        ...
        static EffectSprite *createWithSpriteFrameName(const std::string &filename);
        ...
        void initLampWithSpriteFrameName(const std::string &normalMapFilename, cocos2d::Color3B darkValue);
